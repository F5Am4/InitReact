...
const Home = () => {
  ...
  useEffect(() => {
    fetch('http://pokeapi.co/api/v2/pokemon?limit=250')
  ...
  return (
    <div className='container'>
      ...
      <form className='form-inline my-2 my-lg-0 w-75'>
        <input
          type='text' className='form-control' id='search' placeholder='Enter name' value={searchTerm}
      ...
      <div className='row'>
        {filteredPokemons.map(pokemon => (
          <div className='col-sm-4' key={pokemon.name}>
            <div className='card'>
              <img
